...
public class HojaSprites {
	...
	public HojaSprites(final String ruta, final int tamanyoSprites, final boolean hojaOpaca) {
	...
	private void rellenarSpritesDesdeImagen(final BufferedImage imagen) {
		for (int y = 0; y < altoHojaEnSprites; ++y) {
			for (int x = 0; x < anchoHojaEnSprites; ++x) {
				...
				sprites[x + y * anchoHojaEnSprites] = new Sprite(imagen.getSubimage(posicionX, posicionY, anchoSprites,
						altoSprites));
			}
		}
	}
